...
class TestGenerateSingle:
    ...
    def test_calls_autogen_with_required_fields_only(self, mocker) -> None:
    ...
    def test_passes_all_optional_fields(self, mocker) -> None:
...
class TestStartSession:
    ...
    def test_starts_chargen_session(self, mocker) -> None:
...
class TestFinalizeSession:
    ...
    def test_finalizes_with_selected_character(self, mocker) -> None:
...
class TestListSessions:
    ...
    def test_returns_sessions_from_api(self, mocker) -> None:
    ...
    def test_returns_empty_list_when_no_sessions(self, mocker) -> None:
...
class TestGetSession:
    ...
    def test_returns_session_from_api(self, mocker) -> None:
